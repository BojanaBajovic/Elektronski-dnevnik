...
// inekcija java mail sendera u nasu klasu EmailServiceImpl
@Autowired
public JavaMailSender emailSender;
 
@Override 
public void sendSimpleMessage(EmailObject object) { // object-instanca klase koju smo mi napravili
	SimpleMailMessage message = new SimpleMailMessage(); // message-instanca klase koju je neko za nas napravio
...
// metoda za slanje poruke sa fajlom, MIME poruke-bold,italic....
@Override 
